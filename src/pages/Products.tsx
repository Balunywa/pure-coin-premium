...
const products = [
  ...
  {
    name: 'Atlas',
    tagline: 'Enterprise at scale.',
    description: 'Enterprise resource management platform designed for large-scale operations and complex organizational needs.',
    category: 'Enterprise',
    status: 'Coming 2025',
    href: null,
    features: ['Resource management', 'Workflow automation', 'Analytics dashboard', 'Multi-tenant'],
  },
  {
    name: 'Horizon',
    tagline: 'The next platform.',
    description: 'A next-generation consumer platform currently in development. Sign up for updates.',
    category: 'Consumer',
    status: 'In Development',
    href: null,
    features: ['Consumer-focused', 'Cross-platform', 'AI-powered', 'Social features'],
  },
];
