    ...
    <section className="py-32 md:py-48 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <FadeIn className="mb-20">
          <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-4 text-label opacity-70">Infrastructure</p>
              ...
              <FadeIn key={feature.title} delay={index * 0.05}>
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-medium mb-3 group-hover:text-foreground transition-colors">{feature.title}</h3>
